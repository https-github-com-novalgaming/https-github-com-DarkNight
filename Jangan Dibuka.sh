...
figlet "Tools"
echo $w"———————————————————————————————————————————"
echo $cy" Author"$r"  : "$cy"Mr.Ramzi "
echo $cy" Copyright"$r"  : "$cy"Dark Night "
echo $cy" YouTube"$r" : "$cy"Dark Evo Official "
echo $cy" Team"$r"    : "$cy"Jawa Timur Cyber Team"
echo $w"———————————————————————————————————————————"
	sleep 2
echo
echo
...
exit
	...
	echo $r"Pilih input Yang bener dong Jelek:v"
	sleep 2
	sh 'Jangan Dibuka.sh'
fi
clear
