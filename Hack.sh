...
echo $w"==============================================="
sleep 1
echo $cy" Author  "$w": "$cy"Mr.Ramzi"
sleep 1
echo $cy" Copyright  "$w": "$cy"Dark Night"
sleep 1
echo $cy" Github  "$w": "$cy"https://github.com/DarkNight"
sleep 1
echo $cy" YouTube "$w": "$cy"Dark Evo Official"
sleep 1
echo $cy" Team    "$w": "$cy"Jawa Timur Cyber Team"
sleep 1
echo $w"==============================================="
echo
sleep 1
